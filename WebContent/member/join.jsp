 ...
 <!-- //header -->
    ...
    <div class='container'>
        <div class="wrapper">
            <div class="image"></div>
            <div class="join">
                <form name="signupForm" id="signupForm" method="post" action="joinPro.jsp">
                    <div class="input">
                    ...
                    <div class="input">
                        <input type="text" class="box" placeholder="아이디"
                            name="id" required>
                            <input type="button"
                            class="btn-primary box" value="아이디중복체크" onclick="dupCheck()"><br>
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        <input type="text" name="sample4_postcode" class="box" id="sample4_postcode"
                            placeholder="우편번호" required>
                    </div>
 
                    <div class="input">
                        <input type="text" name="sample4_roadAddress" class="box"
                            id="sample4_roadAddress" placeholder="도로명주소" required>
                    </div>
                    <div class="input">
                        <input type="text" name="sample4_jibunAddress" class="box"
